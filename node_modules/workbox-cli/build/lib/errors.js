...
exports.errors = {
    ...
    'self.__WB_MANIFEST'.`,
    'no-search-parameters-supplied': common_tags_1.oneLine `Please provide the url search param(s)
    you would like to ignore.`,
    'invalid-search-parameters-supplied': common_tags_1.oneLine `Please provide the valid URL search parameter(s)
