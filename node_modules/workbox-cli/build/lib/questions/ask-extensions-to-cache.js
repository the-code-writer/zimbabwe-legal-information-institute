...
async function askQuestion(globDirectory) {
    ...
    spinner.stop();
    assert_1.default(fileExtensions.length > 0, errors_1.errors['no-file-extensions-found']);
...
async function askExtensionsToCache(globDirectory) {
    ...
    assert_1.default(extensions.length > 0, errors_1.errors['no-file-extensions-selected']);
